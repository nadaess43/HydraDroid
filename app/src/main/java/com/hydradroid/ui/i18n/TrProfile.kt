...
val trProfile = mapOf(
    ...
    "Enabled sources are used for catalogue search and provide download options." to "Включённые учитываются при поиске в каталоге и дают варианты загрузок.",
    "Access code" to "Код доступа",
    "Unlock" to "Разблокировать",
    "Wrong code" to "Неверный код",
