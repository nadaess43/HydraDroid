...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final JlibtorrentLibraryAccessors laccForJlibtorrentLibraryAccessors = new JlibtorrentLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>junrar</b> with <b>com.github.junrar:junrar</b> coordinates and
     * with version reference <b>junrar</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJunrar() {
        return create("junrar");
    }
    ...
    /**
     * Group of libraries at <b>jlibtorrent</b>
     */
    public JlibtorrentLibraryAccessors getJlibtorrent() {
        return laccForJlibtorrentLibraryAccessors;
    }
    ...
    public static class JlibtorrentLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final JlibtorrentAndroidLibraryAccessors laccForJlibtorrentAndroidLibraryAccessors = new JlibtorrentAndroidLibraryAccessors(owner);

        public JlibtorrentLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>jlibtorrent</b> with <b>com.frostwire:jlibtorrent</b> coordinates and
         * with version reference <b>jlibtorrent</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("jlibtorrent");
        }

        /**
         * Group of libraries at <b>jlibtorrent.android</b>
         */
        public JlibtorrentAndroidLibraryAccessors getAndroid() {
            return laccForJlibtorrentAndroidLibraryAccessors;
        }

    }

    public static class JlibtorrentAndroidLibraryAccessors extends SubDependencyFactory {
        private final JlibtorrentAndroidX86LibraryAccessors laccForJlibtorrentAndroidX86LibraryAccessors = new JlibtorrentAndroidX86LibraryAccessors(owner);

        public JlibtorrentAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>arm</b> with <b>com.frostwire:jlibtorrent-android-arm</b> coordinates and
         * with version reference <b>jlibtorrent</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getArm() {
            return create("jlibtorrent.android.arm");
        }

        /**
         * Dependency provider for <b>arm64</b> with <b>com.frostwire:jlibtorrent-android-arm64</b> coordinates and
         * with version reference <b>jlibtorrent</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getArm64() {
            return create("jlibtorrent.android.arm64");
        }

        /**
         * Group of libraries at <b>jlibtorrent.android.x86</b>
         */
        public JlibtorrentAndroidX86LibraryAccessors getX86() {
            return laccForJlibtorrentAndroidX86LibraryAccessors;
        }

    }

    public static class JlibtorrentAndroidX86LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public JlibtorrentAndroidX86LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>x86</b> with <b>com.frostwire:jlibtorrent-android-x86</b> coordinates and
         * with version reference <b>jlibtorrent</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("jlibtorrent.android.x86");
        }

        /**
         * Dependency provider for <b>64</b> with <b>com.frostwire:jlibtorrent-android-x86_64</b> coordinates and
         * with version reference <b>jlibtorrent</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> get64() {
            return create("jlibtorrent.android.x86.64");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jlibtorrent</b> with value <b>2.0.12.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJlibtorrent() { return getVersion("jlibtorrent"); }

        /**
         * Version alias <b>junrar</b> with value <b>8.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
